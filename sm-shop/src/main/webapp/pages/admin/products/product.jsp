...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#productPricePurchase').numeric({allow:"."});
		$('#quantity').numeric();
		$('#ordermin').numeric();
		$('#ordermax').numeric();
		$('#order').numeric();
...
<div class="tabbable">
				...
				<br/><br/>
						...
						<form:hidden path="product.id" />
                  		...
                  		<div class="control-group">
	                        ...
	                        <div class="controls">
	                        		 <input id="dateAvailable" name="dateAvailable" value="${product.dateAvailable}" class="small" type="text" data-date-format="yyyy-MM-dd" data-datepicker="datepicker">
	                                 <script type="text/javascript">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                      <form:input id="productPricePurchase" cssClass="input-large highlight" path="productPricePurchase"/>
                      <span id="help-price" class="help-inline"><form:errors path="productPricePurchase" cssClass="error" /></span>
                  </div>
                </div>
