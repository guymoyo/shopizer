...
function resetGlobalErrors() {
	...
	<div id="main-content" class="container clearfix row-fluid">
			...
			<div class="span8 col-md-8 no-padding">
				...
				<c:url var="changePassword" value="/shop/customer/${store}/password/${token}"/>
				<div id="formError"  class="alert alert-warning" style="display:none;"></div>
				<form:form method="post" action="${changePassword}" id="changePasswordForm" modelAttribute="passwordRequest">
					   <form:errors path="*" cssClass="alert alert-error" element="div" />
						 ...
						 <div class="control-group form-group">
							...
							<div class="controls">
							   ...
							   <form:password path="repeatPassword" cssClass="span3 required checkPassword form-control form-control-md" id="checkPassword" title="${msgRepeatPassword}"/>
